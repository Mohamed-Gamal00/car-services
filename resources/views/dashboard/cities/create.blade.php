                    ...
                    <form action="{{ route('cities.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="row mb-3 mt-3">
                                ...
                                <div class="col-sm-10">
                                    <x-form.input type="hidden" id="sw-lng" name="longitude" readonly/>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-3">
                                ...
                                <div class="col-sm-10">
                                    <x-form.input type="hidden" id="sw-lat" name="latitude" readonly/>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3 mt-3">
                                ...
                                <div class="col-sm-10">
                                    <x-form.input type="hidden" id="ne-lng" name="end_longitude" readonly/>
                                </div>
                            </div>
                            <div class="row mb-3 mt-3">
                                {{--                                <label for="latitude" class="col-sm-2 col-form-label fw-bold"> نهاية خط العرض</label>--}}
                                <div class="col-sm-10">
                                    <x-form.input type="hidden" id="ne-lat" name="end_latitude" readonly/>
                                </div>
                            </div>

                            <div class="row mb-3 mt-3">
                                <label for="latitude" class="col-sm-2 col-form-label fw-bold"></label>
                                <div class="col-sm-10">
    ...
    <script>
        ...
        function initMap() {
            ...
            google.maps.event.addListener(drawingManager, 'overlaycomplete', function (event) {
                ...
                // تحديث عند تحريك أو تعديل المضلع
        ...
        function extractBounds(polygon) {
            ...
            extractPolygonCoordinates(polygon); // حفظ إحداثيات المضلع
        }
