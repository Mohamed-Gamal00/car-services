...
@endsection <div class="form-header">
          <i class="mdi mdi-content-save me-2"></i>
                            حفظ الموظف
                        </button>
                    </div>
...
"form-label-modern">
                  ...
                  ck"></i>
                    ...
                    <div class="form-group-modern">
                        <label class=                  <input type="tel" name="phone" class="form-control form-control-modern" 
                               value="{{ old('phone') }}" placeholder="05xxxxxxxx">
                        @error('phone')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    ...
                    <div class="form-group-modern">
                        <label class="form-label-modern">
                            <i class="mdi mdi-lo             رقم الجوال
                        </label>
      ="text" name="name" class="form-control form-control-modern" 
                               value="{{ old('name') }}" placeholder="أدخل اسم الموظف">
                        @error('name')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
            ...
            <div class="card-body p-4">
                <form autocomplete="off" method="post" action="{{ route('captains.store') }}">
                    ...
                    <div class="form-group-modern">
                        ...
                        <input type                <i class="mdi mdi-account-plus"></i>
                <h4>إضافة موظف جديد</h4>
                <p class="mb-0 mt-2" style="opacity: 0.9;">أدخل بيانات الموظف</p>
