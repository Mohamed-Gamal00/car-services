...
@section('section')
                    ...
                    <form action="{{ route('cities.update', $city->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="row mb-3 mt-3">
                                ...
                                <div class="col-sm-10">
                                    <x-form.input type="text" id="longitude" name="longitude"
                            ...
                            <div class="row mb-3 mt-3">
                                ...
                                <div class="col-sm-10">
                                    <x-form.input type="text" id="latitude" name="latitude"
                            ...
                            <div class="row mb-3 mt-3">
                                ...
                                <div class="col-sm-10">
                                    <x-form.input type="text" id="end_longitude" name="end_longitude"
                                                  value="{{ old('end_longitude', $city->end_longitude) }}" readonly/>
                                </div>
                            </div>
                            <div class="row mb-3 mt-3">
                                <label class="col-sm-2 col-form-label fw-bold">نهاية خط العرض</label>
                                <div class="col-sm-10">
                                    <x-form.input type="text" id="end_latitude" name="end_latitude"
                                                  value="{{ old('end_latitude', $city->end_latitude) }}" readonly/>
                                </div>
                            </div>
    ...
    <script>
        ...
        function initMap() {
            ...
            let cityCenter = {lat: (swLat + neLat) / 2, lng: (swLng + neLng) / 2};
            ...
            searchBox.addListener("places_changed", function () {
                ...
                removeExistingShape(); // إزالة المضلع القديم قبل إضافة الجديد
            ...
            google.maps.event.addListener(drawingManager, 'overlaycomplete', function (event) {
                if (selectedShape) {
                    removeExistingShape(); // إزالة المضلع السابق
                }
                ...
                extractBounds(selectedShape);
                drawingManager.setDrawingMode(null); // تعطيل الرسم بعد أول مضلع
            });
        }
