...
@section('section')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">إضافة خدمة جديدة</h4>
                        ...
                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('description_en') is-invalid @enderror" 
                                                      rows="4" name="description_en"
                                                      placeholder="Detailed service description...">{{ old('description_en') }}</textarea>
                            ...
                            <div class="col-md-6">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('duration') is-invalid @enderror" 
                                                   name="duration" value="{{ old('duration', '01:00') }}" 
                                ...
                                <div class="card border">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            <label class="form-label fw-bold">صورة الخدمة <span class="text-danger">*</span></label>
                                            <input type="file" class="form-control @error('image') is-invalid @enderror" 
                                                   name="image" accept="image/*" required onchange="previewImage(event, 'imagePreview')">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label fw-bold">أيقونة الخدمة (اختياري)</label>
