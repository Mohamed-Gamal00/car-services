...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">تعديل الخدمة</li>
@endsection
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('services.update', $service->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="name_en" value="{{ old('name_en', $service->name_en) }}">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" rows="4" name="description">{{ old('description', $service->description) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" rows="4" name="description_en">{{ old('description_en', $service->description_en) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="number" step="0.01" class="form-control" name="price" value="{{ old('price', $service->price) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="duration" value="{{ old('duration', $service->duration) }}" placeholder="01:30" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select class="form-select" name="is_active">
                                    <option value="1" {{ $service->is_active ? 'selected' : '' }}>نشط</option>
                                    <option value="0" {{ !$service->is_active ? 'selected' : '' }}>غير نشط</option>
                                </select>
                            </div>
                        </div>
                        ...
                        @if($service->image)
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label fw-bold">الصورة الحالية</label>
                            <div class="col-sm-10">
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label fw-bold">تغيير الصورة</label>
                            <div class="col-sm-10">
