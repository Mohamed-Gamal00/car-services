...
@section('front-section')
    ...
    @if (session()->has('warning'))
        <div style="padding: 13px;" class="new-alert text-center alert-warning alert_class p-4">
            {{ session('warning') }}
        </div>
    @endif
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="pic">
                        <img class="cover" src="{{ asset('storage/' . $banner1->image) }}" alt="">
                    </div>
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="pic">
                        <img class="cover" src="{{ asset('storage/' . $banner2->image) }}" alt="">
                    </div>
                </div>
